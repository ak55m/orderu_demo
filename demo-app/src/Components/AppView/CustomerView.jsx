    ...
    return (
        <div className='w-full min-h-screen bg-white px-6 sm:px-14 md:px-0 py-10 flex items-center justify-center mt-10'>
            <div className='w-full md:w-4/5 h-full'>
                ...
                <h3 className='text-center text-2xl font-bold font-sans pb-1'>Order & Get Instant Updates While Your Meal is Prepared.</h3>
                <h3 className='text-center text-2xl font-bold font-sans pb-4'>Place Orders Directly from Your Phone – No Kiosks, No Cashiers or servers</h3>
