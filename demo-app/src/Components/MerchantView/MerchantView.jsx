    ...
    return (
        <div className='bg-white px-6 sm:px-14 md:px-0 flex items-center justify-center mt-10'>
            <div className='w-full md:w-4/5 h-full'>
                <h1 className='text-center text-5xl font-bold font-sans pb-10'>Automation has never been simpler.</h1>
                <h3 className='text-center text-2xl font-bold font-sans pb-1'>Accept in house orders without the need of any staff.</h3>
